...
MODEL_LIST = ["gpt-3.5-turbo", "gpt-3.5-turbo-16k", "wenxin", "wenxin-4", "xunfei", "claude", "claude-3-opus-20240229",
              "gpt-4", "gpt-4-turbo", "gpt-4-turbo-preview", "gpt-4-1106-preview",
              "claude-3-haiku", "claude-3-sonnet", "claude-3-opus",
              "moonshot-v1-8k", "moonshot-v1-32k", "moonshot-v1-128k",
              GPT4_TURBO_PREVIEW, GPT4_TURBO_01_25, QWEN, GEMINI, ZHIPU_AI, MOONSHOT, QWEN_TURBO, QWEN_PLUS, QWEN_MAX]
