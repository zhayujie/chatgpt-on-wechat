...
available_setting = {
    ...
    # coze-discord-proxy配置
    "coze_discord_proxy": False, # 是否使用了coze-discord-proxy，https://github.com/deanxv/coze-discord-proxy
    "coze_discord_proxy_parent_id": "", # [可选] coze-discord-proxy的channnel的父级id
