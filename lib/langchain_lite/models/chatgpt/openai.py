...
from lib.langchain_lite.models.chatgpt.base import BaseChatModel
from lib.langchain_lite.schema import (
    AIMessage,
    BaseMessage,
    ChatGeneration,
    ChatMessage,
        ...
        try:
            ...
            if not openai.proxy:
                if values.get('proxy'):
                    ...
                    logger.info("success use proxy: {}".format(values['proxy']))
                else:
                    logger.warning("proxy no find, directly request to openai instead")
