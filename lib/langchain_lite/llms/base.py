...
from lib.langchain_lite.callbacks import get_callback_manager
from lib.langchain_lite.schema import BaseLanguageModel, Generation, LLMResult, PromptValue
...
def get_prompts(
    ...
    for i, prompt in enumerate(prompts):
        if lib.langchain_lite.llm_cache is not None:
            cache_val = lib.langchain_lite.llm_cache.lookup(prompt, llm_string)
...
def update_cache(
    ...
    for i, result in enumerate(new_results.generations):
        ...
        if lib.langchain_lite.llm_cache is not None:
            lib.langchain_lite.llm_cache.update(prompt, llm_string, result)
...
class BaseLLM(BaseLanguageModel, BaseModel, ABC):
    ...
    def generate(
        ...
        if lib.langchain_lite.llm_cache is None or disregard_cache:
